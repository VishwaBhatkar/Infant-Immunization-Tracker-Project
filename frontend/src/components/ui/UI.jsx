...
export const EmptyState = ({ title = 'No data available', message = 'New information will appear here.', icon = 'file-tray-outline', imageSource, imageLabel }) => {
    ...
    return (
        <Card style={styles.emptyCard}>
            {imageSource ? <Image source={imageSource} resizeMode="cover" accessibilityLabel={imageLabel || title} style={styles.emptyImage} /> : null}
...
const styles = StyleSheet.create({
    ...
    emptyImage: { width: '100%', maxWidth: '100%', height: 140, borderRadius: 14, marginBottom: 14 },
