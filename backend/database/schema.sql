...
drop database child_vaccination_db
...
ALTER TABLE notification_log ADD COLUMN preference_channels_sent BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE notification_log ADD COLUMN preference_channel_response JSON NULL;



ALTER TABLE notification_log
MODIFY COLUMN related_record_id BIGINT UNSIGNED NULL;